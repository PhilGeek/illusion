...
However, the reasoning in the case of the pointillist painting is unsound as Hilbert's \citeyear{Hilbert:1987jq} discussion of Berkeley's \citeyear{Berkeley:1734fk} argument from microscopes reveals. % Given the formal and material analogies, this naturally raises a doubt about the soundness of the reasoning to the conclusion that the apparent color of the Benham disk is illusory. As we will see, careful reflection on this doubt leads, not to the conclusion that the spinning disk really is reddish, but to the conclusion that the standard conception of illusion is misconceived.
