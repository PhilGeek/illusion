...
To bring out the problem, I want to compare the subjective colors produced by the Benham disk with the apparent colors produced by pointillist paintings. The reasoning to the conclusion that the relevant color appearances are illusory are structurally parallel. Unfortunately, the color appearances presented by pointillist paintings are nonillusory. The unsoundness of the argument that the apparent color of the pointillist painting is illusory naturally raises a doubt about the soundness of the argument that the apparent color of the Benham disk is illusory. Careful reflection on this doubt leads, not to the conclusion that the spinning disk really is reddish, but to the conclusion that the standard conception of illusion is misconceived.% A proper understanding of these renders unsound the reasoning to the conclusion that the subjective colors produced by Benham's disk are illusory.
