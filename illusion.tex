...
To bring the problem out, I want to compare the subjective colors produced by Benham disks with two other chromatic phenomena. A proper understanding of these renders problematic the reckoning of the subjective colors produced by Benham disks as illusory.

\subsection{Pointillism}\label{sub:pointillism} % (fold)

Imagine, if you will, viewing a minimalist painting in a gallery. From your current vantage point, the surface of the painting appears a uniform if luminous green. Closer inspection is revealing, however. As you move in for a closer look, the painting is discovered to be not only minimalist, but pointillist. The luminous green appearance of the surface was achieved by painstakingly painting minute yellow and blue dots across the surface. In fact no part of the surface of the painting is green---every part of the surface is either yellow or blue. One might be tempted, then, to conclude that the green appearance of the painting was illusory---though it would be understandable if one were to feel hesitant in giving in to temptation in this instance. If no part of the surface of the painting is green, then how could the green appearance be veridical? 
